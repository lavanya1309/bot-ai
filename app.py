...
def format_tables(text):
    ...
    text = re.sub(r'<table>', '<table class="comparison-table">', text)
    return text
...
When the user asks for a comparison or the difference between two or more items, you MUST present the information as a Markdown table.

For comparison questions (like "difference between X and Y", "compare A and B", "X vs Y"), respond with:
